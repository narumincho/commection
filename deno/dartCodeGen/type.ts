export type DartCode = {
   ...
   */
  readonly importPackageAndFileNames: ReadonlyArray<ImportPackageFileNameAndAsName>;
...
export type ImportPackageFileNameAndAsName = {
  ...
  readonly asName: string | undefined;
};

export type Declaration = ClassDeclaration | EnumDeclaration;
...
export type ClassDeclaration = {
  ...
  readonly modifier: ClassModifier | undefined;
...
export type ClassModifier = "abstract" | "sealed" | "final";
...
export type MethodType = "normal" | "override" | "static";
...
export type Expr =
  | { readonly type: "IntLiteral"; readonly value: number }
  | {
