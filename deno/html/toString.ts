 ...
 * 文字列の HTML を生成する
 */
export const structuredHtmlToString = (option: StructuredHtml): string =>
  "<!doctype html>" +
  htmlElementToString(
    htmlElement(
      "html",
      new Map(
        option.ietfLanguageTag === undefined
          ? []
          : [["lang", option.ietfLanguageTag]]
      ),
      [
        headElement(option),
        htmlElement(
...
const headElement = (view: StructuredHtml): HtmlElement => {
